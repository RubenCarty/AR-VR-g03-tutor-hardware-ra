...
App AR que identifica componentes de computadora con la cámara y muestra guías de ensamblaje en tiempo real.

| Campo | Detalle |
|-------|---------|
| **Tipo XR** | AR |
| **Motor** | Unity 2022.3.62f1 |
| **Tecnología principal** | ARTrackedImageManager + Vuforia Engine |
...
- AR Foundation 5.1.x
- ARTrackedImageManager + Vuforia Engine

### Clonar el repositorio

```bash
git clone https://github.com/RubenCarty/rva-g03-tutor-hardware-ra.git
cd rva-g03-tutor-hardware-ra
```
